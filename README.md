...
- **근거 기준** — 차단 사유로 올릴 수 있는 것은 실행해서 확인한 것뿐입니다. 확인하지 못한 지적은 등급을 낮추되 버리지 않습니다. 확인 없이 단정해 생긴 오탐을 막기 위한 규칙이고, 자세한 배경은 [`docs/operations.md`](docs/operations.md#리뷰-지시문) 에 있습니다.
